...
------------      -------    --------    -----------
2022/1/4 14:00   Bot Zhao      1.0         None
"""
...
from utils.affine import get_extent_from_image, get_spacing_from_affine, assert_affine_is_diagonal
...
def augment_data(data, truth, affine, scale_deviation=None, flip=False, noise_factor=None, background_correction=False,
    ...
    :param data: [channel, x, y, z]
    :param truth: [x, y, z]
    :param affine:
    :param scale_deviation:
    :param flip:
    :param noise_factor:
    :param background_correction:
    :param translation_deviation:
    :param interpolation:
    :return:
    """
...
def augment_img_data(data, affine, scale_deviation=None, flip=False, noise_factor=None, background_correction=False,
                 translation_deviation=None, interpolation="linear"):
    """
...
#     img = r"D:\dataset\tumor_classification\2021.12.13_nii(mask)\2021.12.13_nii\T1+_OAx_T1Flair+C_20210905081006_8.nii"
#     mask = r"D:\dataset\tumor_classification\2021.12.13_nii(mask)\2021.12.13_nii\mask_T1+_OAx_T1Flair+C_20210905081006_8.nii.gz"
#     img = nib.load(img)
#     affine = img.affine
#     mask = nib.load(mask).get_data()
#     img = img.get_data()[np.newaxis, ...]
#     new_img, new_mask = augment_data(img, mask, affine, scale_deviation=0.2, flip=True, noise_factor=0.1,
#                                      background_correction=True, translation_deviation=0.1, interpolation="linear")
#     print(new_img.shape)